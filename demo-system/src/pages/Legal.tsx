    ...
    return (
        <div style={{ 
            ...
            <div style={{ maxWidth: '900px', margin: '0 auto' }}>
                ...
                <h1 style={{ fontSize: '2.5rem', fontWeight: 900, marginBottom: '1.5rem', textAlign: 'center' }}>
                    Правна Информация
                </h1>

                <div style={{
                    background: 'rgba(255,171,0,0.08)', border: '1px solid rgba(255,171,0,0.3)',
                    borderRadius: '16px', padding: '1rem 1.25rem', marginBottom: '2.5rem',
                    color: 'rgba(255,255,255,0.8)', fontSize: '0.9rem', lineHeight: 1.6, textAlign: 'center'
                }}>
                    Това е <strong>демонстрационна среда</strong>. Текстовете по-долу показват какви правни
                    документи системата предоставя на пътниците; фирмените данни са примерни и се заменят
                    с реквизитите на конкретния превозвач при внедряване.
                </div>
                ...
                <section style={{ 
                    ...
                    <div style={{ color: 'rgba(255,255,255,0.7)', lineHeight: 1.6, display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                        <p>Операторът на транспортната услуга (в реалната инсталация — конкретният превозвач), в качеството си на <strong>администратор на лични данни</strong>, уважаваме Вашата неприкосновеност и се ангажираме със защитата на Вашите лични данни съгласно Регламент (ЕС) 2016/679 (GDPR) и Закона за защита на личните данни (ЗЗЛД).</p>
